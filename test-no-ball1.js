...
const taskConfig = {
    task_name: "测试_无ball_1约束_25085-25095",
    period_range: {
        type: "custom",
    ...
    positive_selection: {
        ...
        span_ranges: [{ min: 18, max: 25 }, { min: 26, max: 32 }],  // 保持2个范围
        odd_even_ratios: ["3:2", "4:1"],  // 保持2个比例
        primes_ratios: [],
        ac_values: [4, 5, 6],
        consecutive_settings: { allow_2_consecutive: true, allow_3_consecutive: false },
        red_balls: { ball_1: [], ball_2: [], ball_3: [], ball_4: [], ball_5: [] }  // 移除ball_1约束
    },
